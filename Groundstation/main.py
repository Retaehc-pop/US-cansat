...
class ScreenActivation:
    ...
    def update_container(self, data) -> list:
        ...
        self.update_graph(self.ui_main.ui.C_AltitudeGraph, self.c_pkg_graph, self.c_alt_graph)
        self.update_graph(self.ui_main.ui.C_TempGraph, self.c_pkg_graph, self.c_temp_graph)
        self.update_graph(self.ui_main.ui.C_GpsAltitudeGraph, self.c_pkg_graph, self.c_galt_graph)
    ...
    def update_payload1(self, data) -> list:
        ...
        self.update_main()
        self.update_graph(self.ui_main.ui.P1_AltitudeGraph, self.s1_pkg_graph, self.s1_alt_graph)
        self.update_graph(self.ui_main.ui.P1_TempGraph, self.s1_pkg_graph, self.s1_temp_graph)
        self.update_graph(self.ui_main.ui.P1_RotationGraph, self.s1_pkg_graph, self.s1_rot_graph)
    ...
    def update_payload2(self, data):
        ...
        self.update_graph(self.ui_main.ui.P2_AltitudeGraph, self.s2_pkg_graph, self.s2_alt_graph)
        self.update_graph(self.ui_main.ui.P2_TempGraph, self.s2_pkg_graph, self.s2_temp_graph)
        self.update_graph(self.ui_main.ui.P2_RotationGraph, self.s2_pkg_graph, self.s2_rot_graph)
